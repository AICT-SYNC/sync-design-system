...
body: {
 ...
 body1_Bold: createFontStyle(fontSize["3xl"], fontWeight.bold),
 ...
 body2_Bold: createFontStyle(fontSize["2xl"], fontWeight.bold),
 ...
 body3_Bold: createFontStyle(fontSize.xl, fontWeight.bold),
},
  label: {
